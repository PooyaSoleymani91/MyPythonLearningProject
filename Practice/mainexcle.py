...
tk.Label(tk_root, text="عنوان فهرست بها:").grid(row=1, column=0)
newfb_entry = tk.Entry(tk_root, width=50)
newfb_entry.grid(row=1, column=1)
tk.Label(tk_root, text="ورودی فایل اکسل:").grid(row=0, column=0)
file_entry = tk.Entry(tk_root, width=50)
file_entry.grid(row=0, column=1)
tk.Button(tk_root, text="باز کردن", command=select_file,).grid(row=0, column=2)
tk.Button(tk_root, text="افزودن آیتم ها", command=start_copy).grid(row=1, column=2)
